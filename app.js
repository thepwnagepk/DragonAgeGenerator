...
document.getElementById("OriginPicture").src = "img/" + OriginPicID + ".JPG.jpg";
...
function ClassChoice(){
 ...
 SecondNumber();  
    ...
    Icon1 = Specialisation1.replace(/\s/g, '').toLowerCase();
    Icon2 = Specialisation2.replace(/\s/g, '').toLowerCase();
    document.getElementById("Class").innerHTML = "" + "<strong>" + Specialisation1 + "</strong> and <strong>" + Specialisation2 + "</strong>";
    document.getElementById("icon1").src = "img/" +Icon1 + ".png";
    document.getElementById("icon2").src = "img/" +Icon2 + ".png";
